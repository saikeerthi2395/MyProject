...
public class HomeController {
	...
	public ModelAndView searchPost(@ModelAttribute("uid") int uid) {
		System.out.println("inside search");

		List<Post> list = pImpl.searchById(uid);
		ModelAndView view = new ModelAndView("resources/searchById");
...
///////////////////////////////////////////////for comments impl\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
	...
	public ModelAndView viewUsers() {
		...
		ModelAndView view = new ModelAndView("/viewsUsers");
		view.addObject("list", list);
		return view;
	}
