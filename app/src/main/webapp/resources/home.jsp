			...
			<div class="main-agileinfo">
				...
				<div class="wrap-login100">
                   ...
                   <div class="input-group mb-2" style="margin: 30px">
							...
							<a class="form-control" href="http://localhost:8080/app/resources/searchById.jsp">Search Post by ID</a>
						 ...
						 <div class="input-group mb-2" style="margin: 30px">
							...
							<a class="form-control" href="http://localhost:8080/app/resources/search.jsp">Search Post by Title</a>
						...
						<div class="input-group mb-2" style="margin: 30px">
							...
							<a class="form-control" href="http://localhost:8080/app/resources/viewUsers.jsp">View Users</a>
						</div>
...
<div class="input-group mb-2" style="margin: 30px">
							...
							<a class="form-control" href="http://localhost:8080/app/resources/signIn.jsp">Logout</a>
						</div>
